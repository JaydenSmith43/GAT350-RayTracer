...
int main(int argc, char* argv[])
{
	...
	//std::shared_ptr<Camera> camera = std::make_shared<Camera>(glm::vec3{ 0, 10, 40 }, glm::vec3{ 0, 0, 0 }, glm::vec3{ 0, 1, 0 }, 20.0f, aspectRatio);
	std::shared_ptr<Camera> camera = std::make_shared<Camera>(glm::vec3{ 0, 1, 10 }, glm::vec3{ 0, 0, 0 }, glm::vec3{ 0, 1, 0 }, 20.0f, aspectRatio); //original
